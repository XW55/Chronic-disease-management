  ...
  <view>
    ...
    <view class="result card">
      <view class="result_title flexBox">
        ...
        <view class="dateBox" @click="openBloodCalendar">
          {{ startBloodTime }} ~ {{ endBloodTime }}
          <text style="margin-left: 10rpx" class="iconfont icon-rili"></text>
        </view>
      </view>
      <view class="chart">
        <view class="todayCar">
...
import { getThisWeekDates } from '@/tools/tool.js'
export default {
  components: {
    // qiunDataCharts
  },
