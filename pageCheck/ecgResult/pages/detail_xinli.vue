  ...
  <view>
      ...
      <view class="titleBox">
        ...
        <view class="item">
          ...
          <view style="display: flex; flex-direction: column" @click="jumpMBI()">
            ...
            <span style="line-height: 35rpx; font-size: 0.7rem; color: #4cd9b7">什么是BMI？</span>
          </view>
        </view>
      </view>
    </view>
    ...
    <view class="consult">
      <u-row justify="space-between" class="demo-uni-row" gutter="20">
        <u-col span="6">
          <view class="" style="background-image: linear-gradient(to right, #faeeec, #f8e6e3); padding: 20rpx; border-radius: 25rpx">
            <view class="" style="padding: 10rpx; font-size: 1.1rem">心率</view>
            <view class="" style="padding: 10rpx; font-size: 1.1rem; color: #d86f00">{{ stateData['平均心率'] ? stateData['平均心率'] + '次/分钟' : '暂无数据' }}</view>
          </view>
        </u-col>
        <u-col span="6">
          <view class="" style="background-image: linear-gradient(to right, #f1f2fc, #e7e9fb); padding: 20rpx; border-radius: 25rpx">
            <view class="" style="padding: 10rpx; font-size: 1.1rem">呼吸频率</view>
            <view class="consult_xl_zi" style="padding: 10rpx; font-size: 1.1rem; color: #d86f00">{{ stateData.rps_rate ? stateData.rps_rate + '次/分钟' : '暂无数据' }}</view>
          </view>
        </u-col>
      </u-row>
    </view>
    ...
    <view class="consult">
      <view class="xinli">
        ...
        <view class="xinli_top yellow">
          ...
          <view class="">
            {{ stateData.ecg_power ? stateData.ecg_power : '' }}
            <text style="color: #999999; font-size: 15px; font-weight: 300">ms</text>
          </view>
        </view>
        <view class="jintutiao">
          ...
          <view class="jintutiao_wenzi" :style="{ 'justify-content': 'flex-end', width: shenxinyalikuandu(stateData.ecg_power) }" v-else>
            <view class="sanjiao_wenzi">{{ getBordertext(stateData.ecg_power) }}</view>
            <view class="sanjiao" :style="{ transform: 'translateX(0%)', 'border-bottom-color': getBorderColor(stateData.ecg_power) }"></view>
          </view>
        </view>
        <view class="xinli_contan">{{ stateData.ecg_power_text }}</view>
        <view class="xinli_bottom" @click="xinlinengliang">
          详情解读
    ...
    <view class="consult">
      <view class="xinli">
        ...
        <view class="xinli_bottom" @click="qingxuyali()">
          详情解读
          <uni-icons type="right"></uni-icons>
        </view>
      </view>
    ...
    <view class="consult">
      <view class="xinli">
        ...
        <view class="jintutiao">
          <view class="jintutiao_shuzi" style="color: #bac2ce">
            <view style="width: 20%; box-sizing: border-box; color: #bac2ce; text-align: right; display: flex; justify-content: space-between">
              <view style="color: #bac2ce">0</view>
              <view style="color: #bac2ce">20</view>
            </view>
          ...
          <view class="jintutiao_wenzi" :style="{ 'border-bottom-color': getBorderColor_xinfen(stateData.excitement), 'justify-content': 'flex-end', width: stateData.excitement + '%' }" v-else>
            <view class="sanjiao_wenzi">{{ getBordertext_xinfen(stateData.excitement) }}</view>
            <view class="sanjiao" :style="{ transform: 'translateX(0%)', 'border-bottom-color': getBorderColor_xinfen(stateData.excitement) }"></view>
          </view>
        </view>
        <view class="xinli_contan">{{ stateData.excitement_text }}</view>
        <view class="xinli_bottom" @click="xinfen">
          详情解读
          <uni-icons type="right"></uni-icons>
        </view>
      </view>
      ...
      <view class="xinli">
        ...
        <view class="jintutiao">
          ...
          <view class="jintutiao_wenzi" :style="{ 'border-bottom-color': getBorderColor_xinfen(stateData.relax), 'justify-content': 'flex-end', width: stateData.relax + '%' }" v-else>
            <view class="sanjiao_wenzi">{{ getBordertext_fangsong(stateData.relax) }}</view>
            <view class="sanjiao" :style="{ transform: 'translateX(0%)', 'border-bottom-color': getBorderColor_fangsong(stateData.relax) }"></view>
          </view>
        </view>
        <view class="xinli_contan">{{ stateData.relax_text }}</view>
        <view class="xinli_bottom" @click="fangsong">
          详情解读
          <uni-icons type="right"></uni-icons>
        </view>
      </view>
      ...
      <view class="xinli">
        ...
        <view class="jintutiao">
          ...
          <view class="jintutiao_wenzi" :style="{ 'border-bottom-color': getBorderColor_mbi(bmi), 'justify-content': 'flex-end', width: bmikuandu(bmi) }" v-else>
            <view class="sanjiao_wenzi">{{ getBordertext_bmi(bmi * 1) }}</view>
            <view class="sanjiao" :style="{ transform: 'translateX(0%)', 'border-bottom-color': getBorderColor_mbi(bmi) }"></view>
          </view>
        </view>
        <!--      <view class="xinli_contan">{{stateData.relax_text}}</view>-->
        <view class="xinli_bottom" @click="jumpMBI()">
          详情解读
          <uni-icons type="right"></uni-icons>
        </view>
      </view>
...
.green {
  background-image: linear-gradient(to right, rgb(23, 208, 107), rgba(255, 255, 255, 0));
}
.red {
  background-image: linear-gradient(to right, rgb(232, 118, 89), rgba(255, 255, 255, 0));
}
.zise {
  background-image: linear-gradient(to right, rgb(124, 58, 237), rgba(255, 255, 255, 0));
}
